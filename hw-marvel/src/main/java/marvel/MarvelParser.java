...
public class MarvelParser {
     ...
     * @param characters the list of characters in the file
     * @param books the list of books in the file
     */
    // TODO: Replace 'void' with the type you want the parser to produce
    public static void parseData(String filename, HashSet<String> characters, HashMap<String, List<String>> books) {
