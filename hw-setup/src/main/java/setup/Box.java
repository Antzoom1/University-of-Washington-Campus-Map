...
public class Box implements Iterable<Ball> {
    ...
    public boolean add(Ball b) {
        // Your code goes here.  Remove the exception after you're done.
        if(b != null && (!ballContainer.contains(b)) && b.getVolume() + ballContainer.getVolume() <= maxVolume) {
            ballContainer.add(b);
            return true;
        } else {
            return false;
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        // Your code goes here.  Remove the exception after you're done.
        Iterator<Ball> iterate = ballContainer.iterator();
        ArrayList<Ball> listBalls = new ArrayList<>();
        while(iterate.hasNext()) {
            listBalls.add(iterate.next());
        }
        Collections.sort(listBalls, new comparator());
        return listBalls.iterator();
    }
    ...
    public class comparator implements Comparator<Ball> {
